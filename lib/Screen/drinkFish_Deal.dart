...
class DrinkFishDeal extends StatefulWidget {
  const DrinkFishDeal({Key? key}) : super(key: key);
  @override
  State<DrinkFishDeal> createState() => DrinkFishDealState();
}
class DrinkFishDealState extends State<DrinkFishDeal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFf141420),
        title: Text("Drink Like a Fish",style: GoogleFonts.poppins(textStyle: appBarText),),
      ),
      body: ListView(
          children:[
            ...
            Padding(
              ...
              child: Row(  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Drink Like a Fish",style: GoogleFonts.robotoSlab(textStyle:  bigTitle)),
                  Row(
                    children: [
            ...
            Row(
              ...
              children: const [
                Padding(
                  ...
                  child: SizedBox(
                    width: 250,
                    child: Text('Recommended Drink Like a Fish deals',
                        maxLines:2,
