...
class JumpStartDeals  extends StatefulWidget {
  const JumpStartDeals({Key? key}) : super(key: key);

  @override
  State<JumpStartDeals> createState() => JumpStartDealsState();
}

class JumpStartDealsState extends State<JumpStartDeals> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFf141420),
        title: Text("Jump start menu deal",style: GoogleFonts.poppins(textStyle: appBarText),),
      ),
      body: ListView(
          children:[
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                              width:40,
                              height:40,
                              child: Image.asset("assest/chili.png",fit: BoxFit.fill,)),
                          const SizedBox(height: 3,),
                          const Text('Spicy', textAlign: TextAlign.center, style: cardSubtitle),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                              width:40,
                              height:40,
                              child: Image.asset("assest/noodles.png",fit: BoxFit.fill,)),
                          const Text('Tangy', textAlign: TextAlign.center, style: cardSubtitle),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                              width:40,
                              height:40,
                              child: Image.asset("assest/english-breakfast.png",fit: BoxFit.fill,)),
                          const SizedBox(height: 3,),
                          const Text('English', textAlign: TextAlign.center, style: cardSubtitle),
                        ],
                      ),
                    ),
                  ),
                        ...
                        children: [
                          InkWell(
                            ...
                            child: SizedBox(
                                width:40,
                                height:40,
                                child: Image.asset("assest/breakfast.png",fit: BoxFit.fill,)),),
                          const Text('Authentic', textAlign: TextAlign.center, style: cardSubtitle),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          SizedBox(
                              width:45,
                              height:45,
                              child: Image.asset("assest/hot-soup.png",fit: BoxFit.fill,)),
                          const SizedBox(height: 3,),
                          const Text('Soup', textAlign: TextAlign.center, style: cardSubtitle),
                        ],
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Row(  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Jump Start menu / Healthy",style: GoogleFonts.robotoSlab(textStyle:  bigTitle)),
                  Row(
                    children: [
            ...
            Row(
              ...
              children: const [
                Padding(
                  ...
                  child: SizedBox(
                    width: 250,
                    child: Text('Recommended Jump Start menu deals',
                        maxLines:2,
