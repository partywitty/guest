...
class _setPasswordState extends State<setPassword> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text('New Password',style: labelText),
            ),
            TextFormField(
              validator: (value) {
            ...
            const Padding(
              ...
              child: Text('Confirm Password',style: labelText),
            ),
            TextFormField(
              validator: (value) {
                if (value == null || value.isEmpty) {
  ...
  Future<void> changePassword({confirm,required BuildContext context}) async {
    try{
      var request = http.MultipartRequest('POST', Uri.parse(Api_link.setPassWord));
      request.fields.addAll({
        'guast_id': widget.userId,
        'password': confirm,
      });
